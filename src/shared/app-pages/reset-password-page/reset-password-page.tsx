  ...
  return (
    <div className="flex h-[100vh] items-center justify-center">
      <CardWrapper className='max-w-[472px] px-8 py-16'>
        ...
        <Heading variant='xl' className='mb-2'>Создайте новый пароль</Heading>
        <Text variant='m' className='mb-6'>Чтобы завершить восстановление, придумайте новый надежный пароль для вашего аккаунта.</Text>
